...
class FlightBoarding implements ShouldBroadcast
{
    ...
    public function broadcastWith(): array
    {
        return [
            ...
            'boarding_message' => $this->boardingMessage ?: "Flight {$this->flight->flight_number} is now boarding at gate {$this->flight->gate}",
